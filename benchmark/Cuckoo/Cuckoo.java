...
public class Cuckoo {
    ...
    private int fingerprintLen;
    private int itemsInCuckoo;
    ...
    public Cuckoo(int buckets, int bucketEntries, int maxKicks, double errorRate){
    ...
    public boolean insert(String x){
        ...
        for(int entry = 0; entry < bucketEntries ; entry++){
        ...
        for(int kick = 0; kick < maxKicks; kick++){
            int randomBucketEntry = rand.nextInt(bucketEntries);
