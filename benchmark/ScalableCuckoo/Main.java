...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        maxKicks = parseArguments(args, "-k", 500);
        bucketEntries = parseArguments(args, "-b", 4);
        scaleFactor = parseArguments(args, "-s", 2);
        buckets = parseArguments(args, "-n", 4);

        nameSpaceSize = numberOfInserts * 1;

        nameSpace = new String[nameSpaceSize];
        ScalableCuckoo cuckoo = new ScalableCuckoo(buckets, bucketEntries, maxKicks, errorRate,scaleFactor);
